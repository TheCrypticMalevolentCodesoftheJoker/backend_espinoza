    ...
    <div class="app-layout">
        <aside class="sidebar">
            <div class="sidebar-brand">
                <img src="<?php echo e(asset('logo.webp')); ?>" alt="Logo" class="brand-logo">
            ...
            <header class="header">
                ...
                <div class="header-actions">
                    <div class="status-indicator">
                        <span class="badge-env">Laravel <?php echo e(app()->version()); ?></span>
                    </div>
                </div>
            </header>
                ...
                <section id="sect-overview" class="tab-section active">
                    ...
                    <div class="grid-layout cols-3">
                        <div class="info-card">
                            ...
                            <p class="info-card-desc"><?php echo e($dbMessage); ?> — <?php echo e(config('database.connections.mysql.database', 'espinoza_sac')); ?>@localhost</p>
                        </div>
                        <div class="info-card">
                            <div class="info-card-header">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="info-card-icon">
                            ...
                            <p class="info-card-desc"><?php echo e($_SERVER['HTTP_HOST'] ?? '127.0.0.1:8000'); ?> (Debug: <?php echo e(config('app.debug') ? 'ON' : 'OFF'); ?>)</p>
                        </div>
                        <div class="info-card">
                            <div class="info-card-header">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="info-card-icon">
                ...
                <section id="sect-architecture" class="tab-section">
                    ...
                    <div class="info-card">
                        ...
                        <table class="val-table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $requires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $libName => $libVer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                $map = $libInfo[$libName] ?? ['name' => $libName, 'desc' => 'Librería auxiliar del backend.', 'category' => 'Paquete'];
                                ?>
                                <tr>
                                    <td><strong><?php echo e($map['name']); ?></strong> <code class="table-lib-name"><?php echo e($libName); ?></code></td>
                                    <td><code><?php echo e($libVer); ?></code></td>
                                    <td><span class="sub-badge table-category-badge"><?php echo e($map['category']); ?></span></td>
                                    <td class="table-lib-desc"><?php echo e($map['desc']); ?></td>
                                </tr>
